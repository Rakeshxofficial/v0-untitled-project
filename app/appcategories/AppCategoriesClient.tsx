...
export default function AppCategoriesClient() {
  ...
  useEffect(() => {
    ...
    const subscription = supabase
      .channel("app-categories-page-changes")
      .on(
        "postgres_changes",
        {
          event: "*",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">App Categories</h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center shadow-md">
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            No app categories found. Check back later or browse our apps directly.
          </p>
          <Link
            href="/apps"
