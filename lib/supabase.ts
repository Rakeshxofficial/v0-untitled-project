...
if (!supabaseUrl || supabaseUrl.length === 0) {
  throw new Error("Missing environment variable: NEXT_PUBLIC_SUPABASE_URL. Please ensure your .env file contains this variable.")
}

if (!supabaseAnonKey || supabaseAnonKey.length === 0) {
  throw new Error("Missing environment variable: NEXT_PUBLIC_SUPABASE_ANON_KEY. Please ensure your .env file contains this variable.")
}
